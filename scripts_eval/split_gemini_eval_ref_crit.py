...
回答が評価基準を満たしているかだけを厳密に判断して採点してください。
...
if __name__ == "__main__":
    ...
    OUTPUT_CSV = PROJECT_DIR / "scripts_eval/gemini_result/split_gemini_ref_crit20.csv"
