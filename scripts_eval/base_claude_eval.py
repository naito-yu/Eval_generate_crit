...
def claude_eval(pred, input_text):

    # GPT-5版と互換のプロンプト（問題・出力形式・回答）
...
if __name__ == "__main__":
    ...
    OUTPUT_CSV = PROJECT_DIR / "scripts_eval/claude_result/base_claude_eval20.csv"
