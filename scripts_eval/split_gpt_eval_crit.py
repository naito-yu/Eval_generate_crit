...
# ============================================================
# ★ 評価基準1つ用の採点関数（Claude/Geminiと完全互換）
# ============================================================
...
# ============================================================
# ★ メイン処理（基準 split → 個別採点 → 合算ルールに変更済み）
# ============================================================
def run_scoring(input_csv_path, output_csv_path):

    df = pd.read_csv(input_csv_path)

    # ★ 追加列（Claude/Gemini と統一）
    for col in [
    ...
    for idx in tqdm(df.index, desc="GPT-5 採点中"):
        ...
        for ai in [1, 2, 3]:
            ...
            for criterion in criteria_list:
                score, reason = gpt5_eval_single_criterion(
                    pred, question, gold, criterion
                )
...
if __name__ == "__main__":
    ...
    OUTPUT_CSV = PROJECT_DIR / "scripts_eval/gpt_result/split_gpt_crit20.csv"
